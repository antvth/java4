...
<body>
<h1 style="text-align: center;">Mau Sac</h1>
<div class="col-8 offset-2 mt-5 table-responsive">
    ...
    <c:if test="${ f:length(danhSachMS) != 0 }">
        <table class="table table-striped mt-3">
            ...
            <c:forEach items="${ danhSachMS }" var="kh">
                <tr>
                    <td>${ kh.id }</td>
                    <td>${ kh.ma }</td>
                    <td>${ kh.ten }</td>
                    <td>
                        <a class="btn btn-primary"
                           href="/ASS_war_exploded/mau-sac/edit?ma=${ kh.ma }">
                            Cập nhật
                        </a>
                    </td>
                    <td>
                        <a class="btn btn-danger"
                           href="/ASS_war_exploded/mau-sac/delete?ma=${ kh.ma }">
                            Xóa
                        </a>
                    </td>
                </tr>
