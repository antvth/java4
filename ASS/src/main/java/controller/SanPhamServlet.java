...
//                .forward(request, response);
    ...
    protected void edit(
        ...
        request.setAttribute("kh", domainModelSP);
    ...
    protected void delete(
       ...
       String ma  =  request.getParameter("ma");
        ...
        response.sendRedirect("/ASS_war_exploded/san-pham/index");
    }
    @Override
    ...
    protected void store(
        ...
        try {
            ...
            if (ma.trim().equals("") || ten.trim().equals("") ) {
                ...
                response.sendRedirect("/ASS_war_exploded/san-pham/create");
            } else {
                SanPham domainModelCV = new SanPham();
                BeanUtils.populate(domainModelCV, request.getParameterMap());
                this.spRepo.insert(domainModelCV);
                response.sendRedirect("/ASS_war_exploded/san-pham/index");
            }
        } catch (Exception e) {
            e.printStackTrace();
